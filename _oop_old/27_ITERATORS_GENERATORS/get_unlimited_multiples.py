...
Write a function called get_unlimited_multiples, which
accepts a number and returns a generator that will yield an unlimited number of
...
ones = get_unlimited_multiples()
# print([next(ones) for i in range(15)])
